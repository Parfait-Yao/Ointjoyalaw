...
export default async function LeaderPage() {
  ...
  const stats = [
    ...
    { value: orgCount > 0 ? `${orgCount}` : "5", label: "Organisations affiliées" },
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="relative min-h-[85vh] md:min-h-[92vh] flex items-center justify-center overflow-hidden bg-[#0f0224]">
        ...
        <div
          className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-indigo-800/10 blur-[100px] animate-pulse"
        ...
        <div className="container relative z-10 mx-auto px-8 md:px-16 lg:px-24 xl:px-32 max-w-[1600px]">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-24 pt-28 pb-16 md:py-16">
            ...
            <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
              ...
              <p className="text-xl text-purple-100/70 max-w-xl mx-auto lg:mx-0 mb-12 leading-relaxed font-medium">
                Appelé par Dieu pour annoncer la parole de vérité, notre leader
                a consacré sa vie à l&apos;édification du corps de Christ —
                levant des leaders et touchant les nations.
              </p>
            ...
            <div className="flex-shrink-0 order-1 lg:order-2">
              <div className="relative w-80 h-80 md:w-[450px] md:h-[450px]">
                ...
                {/* Floating Badges */}
                <div
                  className="absolute -bottom-6 -left-6 bg-white p-5 rounded-3xl shadow-2xl border border-gray-100 hidden md:block animate-bounce"
        ...
        <div className="container mx-auto px-8 md:px-16 lg:px-24 xl:px-32 max-w-[1600px]">
          <div className="max-w-2xl mx-auto text-center mb-16">
            ...
            <p className="text-gray-500 text-lg leading-relaxed">
              Nous formons des croyants qui ne se contentent pas de connaître
              Dieu, mais qui le vivent, le démontrent et se lèvent comme une
              référence dans leur génération.
            </p>
          </div>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-8 md:px-16 lg:px-24 xl:px-32 max-w-[1600px] text-center max-w-3xl">
          <div className="text-6xl text-[#d4af37]/40 font-serif leading-none mb-6">
            &ldquo;
          </div>
          <blockquote className="text-white text-2xl md:text-3xl font-medium leading-relaxed mb-8">
            Notre vision est de voir une génération transformée par la joie du
            Seigneur et équipée pour accomplir sa destinée divine.
          </blockquote>
          <div className="flex items-center justify-center gap-3">
            <div className="w-10 h-px bg-[#d4af37]" />
            <span className="text-[#d4af37] font-semibold text-sm tracking-wide">
              Visionnaire Titulaire — Ointjoyalaw Ministries
            </span>
            <div className="w-10 h-px bg-[#d4af37]" />
          </div>
        </div>
        ...
        <div className="container mx-auto px-8 md:px-16 lg:px-24 xl:px-32 max-w-[1600px]">
          ...
          <div className="max-w-2xl mx-auto text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5">
              Ceux qui servent <span className="text-[#3b0a68]">avec vous</span>
            </h2>
            <p className="text-gray-500 text-lg leading-relaxed">
              Une équipe dévouée, formée et missionnée pour vous accompagner
              dans votre parcours spirituel.
            </p>
          </div>
          ...
          <div className="mb-8 max-w-5xl mx-auto">
            <div className="relative bg-gradient-to-br from-[#1a043a] to-[#3b0a68] rounded-3xl overflow-hidden flex flex-col md:flex-row items-center gap-0">
              ...
              <div className="relative z-10 p-8 md:p-10 flex-1">
                ...
                <p className="text-[#d4af37] font-semibold mb-5">
                  {team[0].role}
                </p>
                ...
                <div className="flex items-center gap-3">
                  <a
                    href={team[0].social.instagram}
                    className="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors"
                  >
                    <InstagramIcon className="h-4 w-4 text-white" />
                  </a>
                  <a
                    href={team[0].social.facebook}
                    className="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors"
                  >
                    <FacebookIcon className="h-4 w-4 text-white" />
                  </a>
                  <a
                    href={team[0].social.email}
                    className="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors"
                  >
            ...
            {team.slice(1).map((member: any) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-[#3b0a68] text-xs font-semibold mb-3">
                    {member.role}
                  </p>
                  ...
                  <div className="flex items-center gap-2">
                    <a
                      ...
                      className="w-7 h-7 rounded-full bg-[#f4ecf9] hover:bg-[#3b0a68] group/icon flex items-center justify-center transition-colors"
                    >
      ...
      <section className="relative py-24 bg-[#1a043a] overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-8 md:px-16 lg:px-24 xl:px-32 max-w-[1600px]">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-14 gap-4">
            ...
            <Link
              href="/evenements"
              className="inline-flex items-center gap-2 text-purple-300 hover:text-white text-sm font-medium transition-colors shrink-0"
            >
            ...
            {programs.map((prog: any) => (
              ...
              >
                <div className="absolute top-6 left-7 right-7 flex items-center justify-between">
                  <span className="text-xs font-bold tracking-wider uppercase text-white/50 bg-white/10 rounded-full px-3 py-1">
                    {prog.tag}
                  </span>
                ...
                <Link
                  href="/evenements"
                  className="inline-flex items-center gap-2 text-[#d4af37] text-sm font-semibold hover:gap-3 transition-all duration-200"
                >
      ...
      <section className="py-20 bg-[#f4ecf9]">
        <div className="container mx-auto px-8 md:px-16 lg:px-24 xl:px-32 max-w-[1600px] text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1a043a] mb-4 leading-tight">
            Prêt à rejoindre la famille ?
          </h2>
          <p className="text-gray-500 text-lg mb-10 max-w-xl mx-auto">
            Rejoignez Ointjoyalaw Ministries et découvrez une communauté
            vivante, des enseignements forts et une mission claire pour votre
            vie.
          </p>
