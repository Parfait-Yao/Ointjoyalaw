  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Enseignements</h1>
          <p className="text-sm text-gray-500 mt-1">Gérez vos messages, vidéos et supports PDF.</p>
        </div>
        <Link
          href="/admin/enseignements/nouveau"
          className="inline-flex items-center gap-2 bg-purple-800 hover:bg-purple-900 text-white text-sm font-bold rounded-xl px-5 py-3 transition-all shadow-lg shadow-purple-900/10"
        >
