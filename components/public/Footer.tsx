...
export function Footer() {
  ...
  return (
    <footer className="bg-white">
      {/* ── Newsletter Banner ── */}
      <div className="mx-4 md:mx-8 lg:mx-16 -mb-1">
        <div className="relative bg-gradient-to-r from-purple-800 via-purple-700 to-indigo-700 rounded-2xl overflow-hidden px-8 md:px-14 py-10 flex flex-col md:flex-row items-center gap-8">
      ...
      {/* ── Main Footer ── */}
      <div className="bg-gray-50 border-t border-gray-100 pt-20 pb-10 px-4 md:px-8 lg:px-16">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
            ...
            <div className="md:col-span-2 space-y-5">
              <div className="flex items-center gap-2">
                <div className="w-9 h-9 rounded-xl bg-purple-800 flex items-center justify-center shadow">
                  <Cross className="w-4 h-4 text-white" />
                </div>
                <span className="font-bold text-gray-900 text-lg leading-tight">
                  Ointjoyalaw<br />
                  <span className="text-purple-700 font-normal text-sm">Ministries</span>
                </span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  { label: "Let There Be Joy", href: "/organisations" },
                  { label: "ARMES", href: "/organisations" },
                  { label: "MCA", href: "/organisations" },
                  { label: "AMES", href: "/organisations" },
                ].map(({ label, href }) => (
                  <li key={label}>
                    <Link href={href} className="text-gray-500 hover:text-purple-800 text-sm transition-colors duration-150">
                      {label}
          ...
          <div className="mt-12 pt-6 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Ointjoyalaw Ministries. Tous droits réservés.
            </p>
